...
{
    public partial class TopicsPage2 : PhoneApplicationPage
    {
        public TopicsPage2()
        {
            InitializeComponent();
            ...
            //DataContext = App.ViewModel.SelectedTopic;
        }

        private void ListBoxTopicsSelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
        {
